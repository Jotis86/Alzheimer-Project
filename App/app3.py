...
model_path = os.path.abspath(os.path.join(current_dir, 'alzheimer_model.h5'))
train_data_file_path = os.path.abspath(os.path.join(current_dir, 'train.parquet'))
test_data_file_path = os.path.abspath(os.path.join(current_dir, 'test.parquet'))
ml_model_path = os.path.abspath(os.path.join(current_dir, 'best_random_forest_model.pkl'))
feature_selector_path = os.path.abspath(os.path.join(current_dir, 'feature_selector.pkl'))
navigation_image_path = os.path.abspath(os.path.join(current_dir, 'image_3.jpeg'))
home_image_path = os.path.abspath(os.path.join(current_dir, 'image_2.jpeg'))
ml_report_path = os.path.abspath(os.path.join(current_dir, 'ML_Report.pdf'))
dl_report_path = os.path.abspath(os.path.join(current_dir, 'DL_Report.pdf'))
...
if choice == "Home":
    ...
    nutrition_guidelines_path = os.path.join(current_dir, 'Nutrition_Guidelines.pdf')
    smoking_alzheimer_path = os.path.join(current_dir, 'Smoking_and_Alzheimer.pdf')
    lysine_alzheimer_path = os.path.join(current_dir, 'Lysine_and_Alzheimer.pdf')
